...
namespace Assets.SimpleAndroidNotifications
{
    public class NotificationExample : MonoBehaviour
    {
        ...
        {
            NotificationManager.Send(TimeSpan.FromSeconds(1), "Simple notification", "Customize icon and color", new Color(1, 0.3f, 0.15f));
        }
        ...
        /*private void OnApplicationPause(bool pause)
        {
            if (pause)
            {
                NotificationManager.SendWithAppIcon(TimeSpan.FromSeconds(1), "Titulo", "Texto de la notificacion", new Color(0, 0.6f, 1), NotificationIcon.Message);
