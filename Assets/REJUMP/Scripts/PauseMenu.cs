...
public class Shop
{
    ...
    public Characters[] characters = new Characters[15]; //Shop characters array;
}
...
public class Characters
{
    ...
    public GameObject clothesConfiguration;
}
...
public class PauseMenu : MonoBehaviour 
{
	...
	void Start () 
	{
        ...
        gm = GetComponent<JumperGameManager>();
    ...
    void BuyCharacter(int index)
    {
        ...
        else if (shop.characters[index].unlocked && !shop.characters[index].selected)
        {
            ...
            //Set unlock button to not interactable;
            ...
            Destroy(shop.playerSprite.transform.GetChild(0).gameObject);
            Instantiate(shop.characters[index].clothesConfiguration, shop.playerSprite.transform);
            Debug.Log("AQUI SELECCIONA EL PERSONAJE");
    ...
    void LoadShop()
    {
        ...
        Debug.Log(shop.characters[6].characterName);
        for (int i = 0; i < shop.characters.Length; i++)
        {
    ...
    void SetUpShop()
    {
        ...
        for (int i = 0; i < shop.characters.Length; i++)
        {
            ...
            if (shop.characters[i].selected)
            {
                ...
                Instantiate(shop.characters[i].clothesConfiguration, shop.playerSprite.transform);
            }
        }
    }
