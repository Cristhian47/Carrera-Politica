...
public class Player : MonoBehaviour 
{
    ...
    void Start()
    {
        ...
        gm = FindObjectOfType<JumperGameManager>();
    ...
    IEnumerator Respawn()
    {
        ...
        //Reinicia la misión que se está completando si el jugador pierde
        Debug.Log(GameObject.Find("GetChallengesValues").GetComponent<GetJumperChallengeValues>().hudReference.GetScore());
        GameObject.Find("GetChallengesValues").GetComponent<GetJumperChallengeValues>().RestartedGame();
        Debug.Log(GameObject.Find("GetChallengesValues").GetComponent<GetJumperChallengeValues>().hudReference.GetScore());
